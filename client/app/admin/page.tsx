  ...
  const handlePdfDownload = async () => {
    ...
    try {
      ...
      autoTable(doc, {
        ...
        theme: "grid",
        tableWidth: 'auto',
        styles: { fontSize: 8.5, cellPadding: { top: 4, bottom: 4, left: 5, right: 5 }, lineColor: [226, 232, 240], overflow: 'linebreak' },
        headStyles: { fillColor: [15, 23, 42], textColor: [255, 255, 255], fontStyle: "bold", halign: "center" },
        alternateRowStyles: { fillColor: [248, 250, 252] },
        columnStyles: {
          0: { fontStyle: "bold" as const },
          1: { halign: "right" as const, textColor: [30, 111, 194], fontStyle: "bold" as const },
          2: { halign: "right" as const, textColor: [30, 111, 194], fontStyle: "bold" as const },
          3: { halign: "right" as const, textColor: [30, 111, 194], fontStyle: "bold" as const },
          4: { halign: "right" as const, textColor: [30, 111, 194], fontStyle: "bold" as const },
        },
